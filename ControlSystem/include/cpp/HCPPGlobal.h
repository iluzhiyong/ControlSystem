...
#define H_SYSTEM_PROC_NUMBER 1616
#endif
...
LIntExport Herror tuple_split(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Halcon::HTuple *Substrings);
LIntExport Herror tuple_split(const Halcon::HTuple &T1, const Halcon::HTuple &T2, char *Substrings);
LIntExport Herror tuple_split(const char *T1, const char *T2, Halcon::HTuple *Substrings);
...
LIntExport Herror get_sheet_of_light_result_object_model_3d(const Halcon::HTuple &SheetOfLightModelID, Halcon::HTuple *ObjectModel3DID);
LIntExport Herror get_sheet_of_light_result_object_model_3d(const Halcon::HTuple &SheetOfLightModelID, Hlong *ObjectModel3DID);
LIntExport Herror get_sheet_of_light_result_object_model_3d(Hlong SheetOfLightModelID, Halcon::HTuple *ObjectModel3DID);
...
LIntExport Herror fit_primitives_object_model_3d(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &ParamName, const Halcon::HTuple &ParamValue, Halcon::HTuple *ObjectModel3DOutID);
LIntExport Herror fit_primitives_object_model_3d(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &ParamName, const Halcon::HTuple &ParamValue, Hlong *ObjectModel3DOutID);
LIntExport Herror segment_object_model_3d(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &ParamName, const Halcon::HTuple &ParamValue, Halcon::HTuple *ObjectModel3DOutID);
LIntExport Herror segment_object_model_3d(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &ParamName, const Halcon::HTuple &ParamValue, Hlong *ObjectModel3DOutID);
...
LIntExport Herror reconstruct_surface_stereo(const Halcon::Hobject &Images, const Halcon::HTuple &StereoModelID, Halcon::HTuple *ObjectModel3DID);
LIntExport Herror reconstruct_surface_stereo(const Halcon::Hobject &Images, const Halcon::HTuple &StereoModelID, Hlong *ObjectModel3DID);
LIntExport Herror reconstruct_surface_stereo(const Halcon::Hobject &Images, Hlong StereoModelID, Halcon::HTuple *ObjectModel3DID);
LIntExport Herror reconstruct_surface_stereo(const Halcon::Hobject &Images, Hlong StereoModelID, Hlong *ObjectModel3DID);
...
LIntExport Herror create_stereo_model(Hlong CameraSetupModelID, const char *Method, const char *GenParamName, double GenParamValue, Halcon::HTuple *StereoModelID);
...
LIntExport Herror refine_surface_model_pose(const Halcon::HTuple &SurfaceModelID, const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &InitialPose, const Halcon::HTuple &MinScore, const Halcon::HTuple &ReturnResultHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Pose, Halcon::HTuple *Score, Halcon::HTuple *SurfaceMatchingResultID);
LIntExport Herror find_surface_model(const Halcon::HTuple &SurfaceModelID, const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &RelSamplingDistance, const Halcon::HTuple &KeyPointFraction, const Halcon::HTuple &MinScore, const Halcon::HTuple &ReturnResultHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Pose, Halcon::HTuple *Score, Halcon::HTuple *SurfaceMatchingResultID);
...
LIntExport Herror create_surface_model(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &RelSamplingDistance, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *SurfaceModelID);
LIntExport Herror create_surface_model(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &RelSamplingDistance, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *SurfaceModelID);
...
LIntExport Herror copy_object_model_3d(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &Attributes, Halcon::HTuple *CopiedObjectModel3DID);
LIntExport Herror copy_object_model_3d(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &Attributes, Hlong *CopiedObjectModel3DID);
LIntExport Herror prepare_object_model_3d(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &Purpose, const Halcon::HTuple &OverwriteData, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror object_model_3d_to_xyz(Halcon::Hobject *X, Halcon::Hobject *Y, Halcon::Hobject *Z, const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &Type, const Halcon::HTuple &CamParam, const Halcon::HTuple &Pose);
LIntExport Herror xyz_to_object_model_3d(const Halcon::Hobject &X, const Halcon::Hobject &Y, const Halcon::Hobject &Z, Halcon::HTuple *ObjectModel3DID);
LIntExport Herror xyz_to_object_model_3d(const Halcon::Hobject &X, const Halcon::Hobject &Y, const Halcon::Hobject &Z, Hlong *ObjectModel3DID);
LIntExport Herror get_object_model_3d_params(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &ParamName, Halcon::HTuple *ParamValue);
LIntExport Herror get_object_model_3d_params(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &ParamName, char *ParamValue);
LIntExport Herror get_object_model_3d_params(Hlong ObjectModel3DID, const char *ParamName, Halcon::HTuple *ParamValue);
LIntExport Herror get_object_model_3d_params(Hlong ObjectModel3DID, const char *ParamName, char *ParamValue);
LIntExport Herror project_object_model_3d(Halcon::Hobject *ModelContours, const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &CamParam, const Halcon::HTuple &Pose, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror write_object_model_3d(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &FileType, const Halcon::HTuple &FileName, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror read_object_model_3d(const Halcon::HTuple &FileName, const Halcon::HTuple &Scale, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *ObjectModel3DID, Halcon::HTuple *Status);
LIntExport Herror read_object_model_3d(const Halcon::HTuple &FileName, const Halcon::HTuple &Scale, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *ObjectModel3DID, char *Status);
...
LIntExport Herror gen_grid_rectification_map(const Halcon::Hobject &Image, const Halcon::Hobject &ConnectingLines, Halcon::Hobject *Map, Halcon::Hobject *Meshes, const Halcon::HTuple &GridSpacing, const Halcon::HTuple &Rotation, const Halcon::HTuple &Row, const Halcon::HTuple &Col, const Halcon::HTuple &MapType);
LIntExport Herror gen_arbitrary_distortion_map(Halcon::Hobject *Map, const Halcon::HTuple &GridSpacing, const Halcon::HTuple &Row, const Halcon::HTuple &Col, const Halcon::HTuple &GridWidth, const Halcon::HTuple &ImageWidth, const Halcon::HTuple &ImageHeight, const Halcon::HTuple &MapType);
