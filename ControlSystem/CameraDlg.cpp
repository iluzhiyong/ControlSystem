...
//	if(NULL != m_pCamera)
//	{
//		m_pCamera->m_CapInfo.Width = Width;
//		m_pCamera->m_CapInfo.Height = Height;
//		m_pCamera->SetCapInfo();
//	}
//}
//
...
//	switch( nColor )
//	{
//	case 0: Max = 63;  Value = m_pCamera->m_CapInfo.Gain[0];    break;
//	case 1: Max = 63;  Value = m_pCamera->m_CapInfo.Gain[1];    break;
//	case 2:	Max = 63;  Value = m_pCamera->m_CapInfo.Gain[2];    break;
//
//	case 3: Max = 500; Value = m_pCamera->m_CapInfo.Exposure;    break;
//
...
//
//	case 7: Min = 0; Max = MAXWIDTH - m_pCamera->m_CapInfo.Width;		Value = m_pCamera->m_CapInfo.OffsetX;		break;
//	case 8: Min = 0; Max = MAXHEIGHT - m_pCamera->m_CapInfo.Height;    Value = m_pCamera->m_CapInfo.OffsetY;		break;
//
//	}
//
...
//	case 1:  
//	case 2:
//		m_pCamera->m_CapInfo.Gain[0]  = m_pCamera->m_CapInfo.Gain[1]  = m_pCamera->m_CapInfo.Gain[2] = nPos; 	
//		m_pCamera->SetCapInfo(&m_CapInfo);
//		break;		
//
//#else
//	case 0:  m_pCamera->m_CapInfo.Gain[0] = nPos;    m_pCamera->SetCapInfo(); break;
//	case 1:  m_pCamera->m_CapInfo.Gain[1] = nPos;    m_pCamera->SetCapInfo(); break;
//	case 2:	 m_pCamera->m_CapInfo.Gain[2] = nPos;    m_pCamera->SetCapInfo(); break;
//#endif
//	case 3: m_pCamera->m_CapInfo.Exposure = nPos;    m_pCamera->SetCapInfo(); break;
//
//#ifdef DLC131
...
//#endif
//	case 7:  m_pCamera->m_CapInfo.OffsetX = nPos;		m_pCamera->SetCapInfo(); break;
//	case 8:  m_pCamera->m_CapInfo.OffsetY = nPos;		m_pCamera->SetCapInfo(); break;
//
//	}
//	
//	*pResult = 0;
...
//	if(NULL != m_pCamera)
//	{
//		m_pCamera->m_CamFeature.bRawDataShow = m_bRawDataShow;
...
//	if(NULL != m_pCamera)
//	{
//		m_pCamera->m_CamFeature.bBW = m_bBW;
//		m_pCamera->SetCamFeature();
//	}
//}
//
...
//	if(NULL != m_pCamera)
//	{
//		m_pCamera->m_CamFeature.bUpDown = m_bUpDown;
//		m_pCamera->SetCamFeature();
//	}
//}
//
...
//	if(NULL != m_pCamera)
//	{
//		m_pCamera->m_CamFeature.bClearView = m_bClearPreview;
//		m_pCamera->SetCamFeature();
//	}
//}
//
